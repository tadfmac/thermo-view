...
const ws = new WebSocket("wss://4191333.xyz:3052/?room=cheen");
...
var updateThermoMatrix2 = async function(){
  ...
  if(humanPixelCnt > 3){
    var cmax = ((humanPixelCnt - 3)/6) + 1;
    for(var cnt = 0;cnt < cmax; cnt ++){
      await midi.sendNoteOn(1,38,100);
      await midi.wait(30);
    }
  }
};
